...
// toString
var Result;
Result = myBooks.toString() // change array to string
// push method
...
Result = myBooks.shift() // delet first array item
...
randomNumbers.forEach(function(num){
    //console.log()
    console.log(num + 5,"extra") // add extra 5 to each array item like 22+5 , 55+5 ......
})
...
isNumberExists(44)
result = myNumbers.reverse() // arrange the array to reverse
